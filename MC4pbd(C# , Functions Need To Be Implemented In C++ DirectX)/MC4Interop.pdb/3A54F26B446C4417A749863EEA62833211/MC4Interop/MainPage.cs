...
namespace MC4Interop
{
	public class MainPage : PhoneApplicationPage, IApplicationService
	{
		...
		public MainPage()
		{
			...
			this.frameworkDispatcherTimer.set_Interval(System.TimeSpan.FromTicks((long)333333));
		...
		private void Contacts_SearchCompleted(object sender, ContactsSearchEventArgs e)
		{
			...
			shareLinkTask.set_LinkUri(new System.Uri(this.m_link, UriKind.Absolute));
		...
		public void InitializeComponent()
		{
			...
			Application.LoadComponent(this, new System.Uri("/MC4Interop;component/MainPage.xaml", UriKind.Relative));
		...
		private int NetworkAccessType()
		{
			...
			manualResetEvent.WaitOne(System.TimeSpan.FromMilliseconds(500));
			if (num == 0)
			{
